...
export const capitalMedalMetaByState: Record<string, CapitalMedalMeta> = {
  AC: { code: "RBR", motif: "Seringueira", symbol: "rubber-tree" },
  AL: { code: "MCZ", motif: "Coqueiro", symbol: "palm" },
  AP: { code: "MCP", motif: "Marco Zero", symbol: "equator" },
  AM: { code: "MAO", motif: "Vitória-régia", symbol: "victoria-regia" },
  BA: { code: "SSA", motif: "Berimbau", symbol: "berimbau" },
  CE: { code: "FOR", motif: "Jangada", symbol: "jangada" },
  DF: { code: "BSB", motif: "Céu de Brasília", symbol: "brasilia-sky" },
  ES: { code: "VIX", motif: "Mar e pedra", symbol: "sea-cliff" },
  GO: { code: "GYN", motif: "Ipê florido", symbol: "ipe" },
  MA: { code: "SLZ", motif: "Azulejo colonial", symbol: "tiles" },
  MT: { code: "CGB", motif: "Viola de cocho", symbol: "viola" },
  MS: { code: "CGR", motif: "Arara-canindé", symbol: "bird" },
  MG: { code: "BHZ", motif: "Serra mineira", symbol: "mountains" },
  PA: { code: "BEL", motif: "Açaí", symbol: "acai" },
  PB: { code: "JPA", motif: "Sol nascente", symbol: "sunrise" },
  PR: { code: "CWB", motif: "Araucária", symbol: "araucaria" },
  PE: { code: "REC", motif: "Sombrinha de frevo", symbol: "umbrella" },
  PI: { code: "THE", motif: "Encontro dos rios", symbol: "rivers" },
  RJ: { code: "RIO", motif: "Calçadão e onda", symbol: "wave-boardwalk" },
  RN: { code: "NAT", motif: "Sol e dunas", symbol: "sun-dunes" },
  RS: { code: "POA", motif: "Pôr do sol", symbol: "sunset" },
  RO: { code: "PVH", motif: "Barco do Madeira", symbol: "boat" },
  RR: { code: "BVB", motif: "Monte Roraima", symbol: "tepui" },
  SC: { code: "FLN", motif: "Ilha e ponte", symbol: "bridge-sea" },
  SP: { code: "SPO", motif: "Skyline urbano", symbol: "skyline" },
  SE: { code: "AJU", motif: "Caranguejo", symbol: "crab" },
  TO: { code: "PMW", motif: "Girassol", symbol: "sunflower" },
};
